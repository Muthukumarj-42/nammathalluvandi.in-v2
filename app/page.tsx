...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a08] pb-20 md:pb-10 pt-14 md:pt-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-outline-variant/20 pt-4 pb-10 md:pt-6 md:pb-12 px-4 md:px-8">
        ...
        <div className="site-container max-w-4xl mx-auto relative z-10 text-center flex flex-col items-center">
          {/* Saffron tag */}
          <span className="font-display text-sm tracking-[0.2em] text-[#f97316] bg-[#f97316]/10 px-4 py-1.5 uppercase mb-4 md:mb-6 border border-[#f97316]/20 rounded-full">
          ...
          <form action="/explore" method="GET" className="w-full max-w-2xl bg-surface border border-outline-variant/30 p-2.5 flex flex-col md:flex-row gap-2.5 rounded-3xl shadow-premium">
            <div className="relative flex-grow">
              ...
              <input 
                ...
                className="w-full bg-[#160c06] text-on-surface border-none px-4 py-3 pl-10 text-sm outline-none placeholder:text-on-surface-variant/40 rounded-2xl z-0"
              />
